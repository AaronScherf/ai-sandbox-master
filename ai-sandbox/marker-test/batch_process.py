...
PDF_DIR = "./app/data"
OUTPUT_DIR = "./output"
REMOTE_INPUT = "textbook.pdf" # Flat name target to avoid 500 error
...
# Upload the conversion script to the flat root workspace workspace
...
for pdf_path in pdf_files:
    ...
    try:
        print("Uploading PDF to Colab root...")
        # Forcing REMOTE_INPUT uploads it as a flat file, bypassing 500 error folder creation bugs
